---
title: Aula 13 — Pipeline Gráfico
---
...
[:material-file-pdf-box: PDF](pipeline_grafico.pdf){ .md-button target="_blank" }
[:material-file-powerpoint-box: PPT](pipeline_grafico.pptx){ .md-button download }
